...
class Kickbase:
    ...
    def league_player_marketvalue_history(self, league: Union[str, LeagueData], player: Union[str, Player]) -> json:
        league_id = self._get_league_id(league)
        player_id = self._get_player_id(player)
    ...
    def player_info(self, league: Union[str, LeagueData], player_id: str) -> json:
        league_id = self._get_league_id(league)
